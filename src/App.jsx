...
const App = () => {
  ...
  return (
    <>
      <div className="bg-amber-300 min-h-screen h-dvh text-white font-sans relative overflow-hidden">
                ...
                >
                  ...
                  {phoneSpecs.map((spec, index) => (
                    <div key={index} className="flex justify-between text-xs sm:text-sm">
                      ...
                      <span className="font-medium ml-2 sm:ml-1">{spec.value}</span>
                    </div>
                  ))}
                </motion.div>
